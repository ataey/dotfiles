...
# Make less command more friendly for non-text input files, see lesspipe(1)
...
# Enable programmable completion features (not required if already enabled in
# /etc/bash.bashrc, /etc/profilesources, or /etc/bash.bashrc).
